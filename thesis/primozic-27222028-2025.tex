...
\povzetek{
  ...
  nerazcepnih upodobitev končnih grup z gradinentim spustom.
  Vsako nerazcepno upodobitev izrazimo kot
  limito gradientega toka gladke funkcije z ugodnimi začetnimi
  parametri in preučujemo numerične rezultate za ciklične in
  diedrske grupe.

  Metodo razširimo na iskanje delovanj in
  izomorfizmov grafov preko gladke družine distribucij
  nad preslikavami končnih množic. Definiramo
...
\abstract{
  ...
  Each irreducible representation is expressed as
