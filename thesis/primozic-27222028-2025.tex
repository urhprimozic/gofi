  ...
  enačimo $f = (\operatorname{flatten}(f(g_1)),
    ...
    \begin{izrek}
      ...
      \begin{dokaz}
        ...
        Računamo
        $$
        ||H_s - I||_F^2 = ||\operatorname{diag}(\sigma_1, \sigma_2,
        \dotsc, \sigma_n)  - I||_F^2
        = \sum_{i=1}^n (\sigma_i -1)^2.
        $$
        Podobno je
        $$
        ||\s \s^* - I||_F^2 = \sum_{i=1}^n (\sigma_i^2 -1)^2
        $$
        in očitno velja
        $
        ...
        Iz tega sledi
        $$
        ||\s - Q_s||_F^2 = ||H_s - I||_F^2 \leq ||\s \s^* - I||_F^2 < \epsilon.
        $$
