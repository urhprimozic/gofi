...
$$
$\loss$ meri pričakovano število povezav,
ki jih slučajna preslikava $f$ ne ohrani,
$\overline{\loss}$ pa povprečno izgubo na povezavi.
\begin{primer}
  Za izgube metod na sliki \ref{fig:primerjava vanilla-nn-mild-nn}
  velja $\loss = O(n)$, kjer je $n$ velikost grafa.
...
(\emph{overparametrisation}) problema.
...
\begin{figure}
  ...
  \caption{
    Primerjava izgub različnih metod glede
  na velikost grafa.}
