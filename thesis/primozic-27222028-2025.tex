...
\begin{figure}[hp]
  ...
  \caption{Primerjava izgube $\loss_\sim(\overline{P})$
    ...
    oziroma matriki, ki ima v vsaki vrstici enico na mestu največjega elementa (pri parametrizaciji brez tabele inverzij).
  }
...
\begin{figure}
  ...
  na velikost grafa. Permutacijska matrika $\overline{P}$ ustreza najbolj verjetni 
  permutaciji vsake metode. }
