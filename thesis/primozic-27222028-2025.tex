...
vrednost funkcije
izgube $\Loss{homo}(f)$ enaka nič,Y je $f$ upodobitev.
\begin{primer}
  {
...
\begin{opomba}
  ...
  dobimo metodo, ki z visoko verjetnostjo pobegne iz sedel~\cite{jin2017escapesaddlepointsefficiently}. Te lastnosti
...
\begin{opomba}
  ...
  zaprti obliki~\cite{park2024absenceclosedformdescriptionsgradient}. Običajno se jih
  računa numerično.
