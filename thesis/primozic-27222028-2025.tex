          ...
          \hat\rho(s)$ definira slučajno preslikavo\footnote{Izraba
            ...
            $$P(s = f) = \prod _{i=1}^n P(s(i) = f(i)$$
              ...
              \begin{dokaz}
                ...
                Enačbo \eqref{eq:Ps1_inv} z desne pomnožimo z $P_{s_1}$, z leve pa
                z $P_{s_2}^{-1}$ in dobimo
                $$
                P_{s_2}^{-1} = P_{s_3} \dotsm P_{s_m}P_{s_1} - P_{s_1}^{-1}E_r P_{s_1},
                $$          
                ...
                \end{align*}
                Velja  $\prod_{i=1}^m \overline{P_{s_i}} \in \Pi$. Razdalje med različnimi permutacijskimi matrikami
                ne morejo biti manjše od $1$. Iz tega sledi, da je $\prod_{i=1}^m \overline{P_{s_i}} \in \Pi = 1$.
              \end{dokaz}
              %
