...
Naj bo $G=\left<S|R\right>$ končna grupa nad množico generatorjev $S$,
...
$(\operatorname{tr}(R(t), \operatorname{tr(S(t)})$.
    ...
    $\rho \colon G \to \R$ grupe $G=\left<s_G, z_G \mid R\right>$ z dvema
    generatorjema.
    ...
    \hat\rho(s)$ definira slučajno preslikavo\footnote{Izraba
      ...
      Za splošno grupo $G=\left<S|R\right>$ lahko definiramo sledeč
