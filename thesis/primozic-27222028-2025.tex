...
z množico ničel gladke funckije
...
diferencialne enačbe gradientnega toka \emph{gradientnega toka}  (glej
...
\begin{opomba}
  ...
  kjer je $U$ odprta v $\R^n$. Če nadjemo $W = \{a\}$, smo konec. 
...
$(\operatorname{tr}(R(t)), \operatorname{tr}(S(t)))$.
    ...
    izračunane iz iz vzorcev v dodatku
